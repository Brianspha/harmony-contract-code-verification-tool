...
// https://www.shawntabrizi.com/ethereum/verify-ethereum-contracts-using-web3-js-and-solc/
 const verifyByteCode = (compiledByteCode, actualByteCode, solidityVersion) => {
   console.log("compiledByteCode, actualByteCode, solidityVersion: ",compiledByteCode, actualByteCode, solidityVersion)
  const t = trimByteCode(solidityVersion)
  return t(compiledByteCode) === t(actualByteCode)
}


const trimByteCode = (solidityVersion) => (byteCode) => {
